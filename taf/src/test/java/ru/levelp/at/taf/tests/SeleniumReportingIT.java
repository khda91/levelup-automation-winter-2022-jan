...
import ru.levelp.at.taf.listeners.AllureListener;
import ru.levelp.at.taf.listeners.TestLogListener;

@Epic("Add product to compare")
@Listeners({AllureListener.class, TestLogListener.class})
public class SeleniumReportingIT extends SeleniumBaseIT {
